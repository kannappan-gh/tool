...
if os.path.exists("../../hadoop_assessment_report_{}.pdf".format(cur_date)):
    ...
    if os.path.exists("../../hadoop_assessment_tool_{}.log".format(cur_date)):
        if os.path.exists("../../hadoop_assessment_tool_terminal.log"):
            ...
            upload_bucket(JsonCredentials,"../../hadoop_assessment_tool_{}.log".format(cur_date))
        else:
...
try:
	...
	upload_bucket(JsonCredentials,"../../hadoop_assessment_tool_{}.log".format(cur_date))
	upload_bucket(JsonCredentials,"../../hadoop_assessment_tool_terminal.log")
	upload_bucket(JsonCredentials, "../../hadoop_assessment_report_{}.pdf".format(cur_date))
